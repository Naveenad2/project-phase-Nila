  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-[#f8f9fa] selection:bg-nila-200">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
         ...
         <motion.div variants={backgroundBlobVariants} animate="animate" className="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] bg-blue-100/60 rounded-full blur-[150px]" />
      ...
      <div className="relative z-50 flex justify-between items-center p-6 md:p-10">
        <motion.div initial={{opacity:0, x:-20}} animate={{opacity:1, x:0}} className="flex items-center gap-3">
           ...
           {!isAnalyzing && <span className="font-bold text-nila-900 tracking-tight hidden md:block">Assessment AI</span>}
        </motion.div>
        <button 
          onClick={() => router.back()} 
